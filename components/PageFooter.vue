      ...
      <div class="flex justify-center mt-6">
        <div class="bg-white rounded-lg">
          <div class="flex flex-wrap justify-between md:flex-row">
            ...
            />
            <button
              class="w-full m-1 p-2 text-sm bg-teal-500 hover:bg-teal-400 rounded-lg font-semibold uppercase lg:w-auto duration-200 ease-linear"
            >
              Subscribe
            </button>
          </div>
